# The Ops Engine — Links (owner pastes real URLs as accounts go live)

> Publishing + funnel docs pull from this file. See `docs/funnel-setup.md` for
...
---
**Where each link is used**
- BIO_HUB → Instagram bio + every Reel CTA ("link in bio").
- FREE_TEMPLATE → Kit incentive email (Block 3) delivers it.
